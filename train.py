...
assert u_features_tuple[2][1] == v_features_tuple[2][1], 'Number of features of users and items must be the same!'
...
if FEATURES:
    model = RecommenderSideInfoGAE(
								   ...
								   u_features_nonzero=u_features_nonzero, v_features_nonzero=v_features_nonzero, 
								   class_values=class_values, dropout=DO,
    ...
    model = RecommenderGAE(
                           u_features, v_features, u_features_nonzero, v_features_nonzero, class_values, DO,
                           input_dim=u_features.shape[1],
						   feat_hidden_dim=FEATHIDDEN,
                           num_classes=NUMCLASSES,
                           num_support=num_support,
